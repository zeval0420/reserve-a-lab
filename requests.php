<?php
    ...
    if (isset($_SESSION['role']) && $_SESSION['role'] === 'student') {
        ...
        $userID = $_SESSION['employeeID'] ?? 'Guest';
    } else {
    ...
    <body>
        ...
        <div class="custom-modal-overlay"
            ...
            <div class="custom-modal" id="approve-modal">
                ...
                <!-- Modal Body -->
                <div class="custom-modal-body" id="approveDetails"></div>
            </div>
        </div>
        ...
        <div class="custom-modal-overlay"
            ...
            <div class="custom-modal" id="reject-modal">
                ...
                <!-- Modal Body -->
                <div class="custom-modal-body" id="rejectDetails"></div>
            </div>
        </div>
    ...
    <script>
        $(function () {
            ...
            $('.view-btn').on('click', function () {
                ...
                if (status === 'Approved') {
                    $('#approveRequestId').text(
                        'REQ-' + String(data.id).padStart(4, '0')
                    );

                    $('#approveControlNumber').text(
                        data.controlNumber || '—'
                    );
            ...
            $('#rejectModalClose').on('click', function () {
